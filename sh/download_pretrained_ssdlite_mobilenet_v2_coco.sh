curl http://download.tensorflow.org/models/object_detection/ssdlite_mobilenet_v2_coco_2018_05_09.tar.gz -o data/object_detection_api/data/pretrained/model.tar.gz
